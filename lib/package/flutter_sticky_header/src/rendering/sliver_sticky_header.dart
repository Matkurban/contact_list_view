...
class RenderSliverStickyHeader extends RenderSliver with RenderSliverHelpers {
  ...
  void performLayout() {
    ...
    if (child == null) {
      ...
      child!.layout(
        constraints.copyWith(
          ...
          overlap:
              math.min(headerExtent, constraints.scrollOffset) + (sticky ? constraints.overlap : 0),
    ...
    if (header != null) {
      ...
      if (sticky && _isPinned && headerScrollRatio <= 1) {
      ...
      if (header
        ...
        SliverStickyHeaderState state = SliverStickyHeaderState(
